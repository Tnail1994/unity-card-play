	...
	IPointerUpHandler
{
	...
	public void OnPointerExit(PointerEventData eventData)
	{
		...
		// Avoid hover events when the cursor is not moving, as it can cause flickering
		// This means: Card is sizing and moving and the mouse could get outside of the card
		// so the OnPointereExit and Enter is flickering

		if (eventData.delta is { x: 0, y: 0 })
		{
			StartCoroutine(ResetIsHoveredState());
			return;
		}
	...
	private IEnumerator ResetIsHoveredState()
	{
